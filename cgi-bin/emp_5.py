...
def query1():
    ...
    if query!=None:
        ...
        if len(data)==0:
            ...
            print "<h1>MOVIES CURRENTLY RENTED OUT OF THE STORE</h1>\n"
            
            print """<table id='table' border="1">
            <tr><th>Customer ID</th><th>First Name</th><th>Last Name</th><th>Billing Address</th>
            <th>Shipping Address</th><th>Movie ID</th><th>Title</th><th>Photo</th><th>Date Issued</th><th>Due Date</th></tr>"""
            ...
            while i<len(data):
                ...
                print """
                    ...
                    <td><img src="/htdocs/img/%s.jpg" width=100 height=100></td><td>%s</td><td>%s</td>
                        
                       

                    </tr>"""%(data[i][0],data[i][1],data[i][2],data[i][3],data[i][4],data[i][5],data[i][6],data[i][6],data[i][8],data[i][9])
